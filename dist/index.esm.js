...
var createPdf = function createPdf(map, locationValue, setLoading) {
  ...
  renderMap.once("idle", function () {
    ...
    var textBuffer = 1;
    var lineHeight = 3.25;
    var text = nmConverter(locationValue.address);
    ...
    pdf.setFontSize(10);
    pdf.text("Bewegungsradiusrechner (15km) für:", 6, offsetY + marginTop); //Render inner infobox
...
var CreatePdfButton = function CreatePdfButton() {
  ...
  }, /*#__PURE__*/React.createElement(BiPrinter, null)));
};

export { CreatePdfButton, MapComponentsProvider, MapContext, MapLibreMap };
